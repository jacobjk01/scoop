    ...
    return (
        <SafeAreaView style={{height: '100%', width: '100%', backgroundColor: white}}>
            <View style={{width: '60%', marginLeft: 'auto', marginRight: 'auto', marginTop: 'auto', marginBottom: 'auto'}}>
                <Text style={{...smallBold, marginLeft: 'auto', marginRight: 'auto', marginBottom: 50, color: black}}>
                    Welcome to Otour. 
                </Text>
                <TouchableOpacity
                ...
                >
                    <Text style={{...smallBold, color: white, marginLeft: 'auto', marginRight: 'auto', marginTop: 'auto', marginBottom: 'auto', fontSize: 15}}>
                        Visitor
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity
