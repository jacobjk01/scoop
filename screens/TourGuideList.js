...
const HomePage = ({navigation}) => {
  ...
  const checkDate = () => {
    if ((time.selectedTime[0] == true || time.selectedTime[1] == true || time.selectedTime[2] == true || time.selectedTime[3] == true) && calender.selected != '') {
      return(<FlatList
      style={{}}
      vertical={true}
      data={guideimages}
    ...
    />)
      ...
      else if((time.selectedTime[0] == false && time.selectedTime[1] == false && time.selectedTime[2] == false && time.selectedTime[3] == false) && calender.selected != ''){
        return(
          <View style={{alignItems: 'center'}}>
            <Text style={[styles.greyText, {width: '50%',}]}>
    ...
    <SafeAreaView style={{backgroundColor: colors.grayLight}}>
      ...
      ListHeaderComponent={
        ...
        <View style={[styles.backCard, {paddingBottom: 10, height: 390}]}>
          <Text style={[styles.sectionText, {marginTop: 20}]}>Select Date</Text>
