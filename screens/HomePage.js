    ...
    return(
      <SafeAreaView>
          <ScrollView style={{paddingRight: 20, paddingLeft: 20, height: "100%"}}>
              ...
              <FlatList style={{marginTop: 10}} horizontal={true} data={tourimages} renderItem={({item}) => 
              ...
              data={guideimages} renderItem={({item}) => 
                  <TouchableOpacity onPress={() => navigation.navigate("TourGuideProfile")}>
